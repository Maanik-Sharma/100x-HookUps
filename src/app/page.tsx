...
// import CameraSection from '@/components/camera/camera-section';
...
// import CameraPermissionPage from '@/components/camera/camera-permission-skeleton';
...
import Footer from '@/components/footer';
import LatentCard from '@/components/latent-card';
import CameraPermissionPage from '@/components/camera/camera-permission-skelteon';
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-red-900 to-pink-800">
      {!showCamera ? (
        <>
          <HeroSection onSearch={() => setShowCamera(true)} />
          <section className="container mx-auto px-7 pt-24 pb-28">
            <TracingBeamDemo/>
            <h2 className="text-3xl font-bold text-center mb-12 text-neutral-50 mt-10">
              Why Choose 100xHookUps?
            </h2>
        ...
        <>
          {!isCameraPermissionGranted ? (
            <CameraPermissionPage 
              onPermissionGranted={() => setIsCameraPermissionGranted(true)} 
            />
          ) : (
            <>
              <CameraSection />
